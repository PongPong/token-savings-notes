...
| P-OW | [Open-weights / offline](../TYPESAFE-JEV.md#open-weights-alternative-laya) · [laya-mlx](../TYPESAFE-JEV.md#apple-silicon-laya-mlx) · [decision-backend chooser](../TYPESAFE-JEV.md#alternatives-landscape-decision-backends) | N/A (local runtime, or a decision API the product already calls). | Apple Silicon Laya: `pip install laya-mlx`, then `laya-mlx predict`. Other backends (hosted Jev, djev, OpenJev, SemIf): chooser in TYPESAFE-JEV. No scores on this row. |
