...
| P-CU | [Computer-use hygiene](../NOTES.md#computer-use-token-hygiene) / [CUA-S1](../TYPESAFE-JEV.md#10-computer-use--specialist-system-one-for-local-gui-decisions-cua-s1) | Rare in pure chat. Prefer vendor “fill form” / connectors over pasting screenshots. | Frontier plans; S1/Jev scores local actions; structured DOM ≫ screenshots; skip filled fields. |
